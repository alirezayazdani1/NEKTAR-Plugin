...
class Cmodes{
 public:
  ...
  double     *Cedge_store[MAXFACETS];  /* Modes of curved co-ordinates along edge */
  double    **Cface_store[Max_Nfaces]; /* Modes of curved co-ordinates along face */
...
class Element{
 public:
  ...
  /* Paris: Need this for moving mesh viz */
  Vert    *vert_store;
