...
public:
  ...
  Quad(Element *);                                    // constructor
  Quad(int i_d, char ty, int *qsize, int *jsize, Coord *X);
  Quad(int i_d, char ty, int L, int Qa, int Qb, int Qc, Coord *X);
  ...
  // Operators
  Quad& operator=(Quad&);                              // assignement operator
  Quad& operator*=(Quad&);                             // mulitplying operator
  Quad& operator*=(double&);                          // mulitplying operator
  Quad& operator+=(Quad&);                             // addition operator
  ...
  // Element Identifier
  Nek_Facet_Type identify(){ return Nek_Quad;}            // identify
  ...
  void dump_mesh(FILE*);
  void resize(int* size, char);                     // change storage/orders
  ...
  void genArc  (Curve *cur, double *, double *);
  void genNaca4(Curve *cur, double *, double *);
  void genFile (Curve *cur, double *, double *);
