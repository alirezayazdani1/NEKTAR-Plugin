...
static void WriteS(Element_List **E, FILE *out, int nfields, int Snapshot_index){
  ...
  default:
    ...
    sprintf(fname_vtk,"surf_test18a");
    write_vtk_file_XML(XYZ,UVWP,vert_ID_array, Nvert_total, Nelements_total, vert_ID_array_length, 10, fname_vtk, FLAG_DUMP_INDEX, 1);
    FLAG_DUMP_INDEX++;
